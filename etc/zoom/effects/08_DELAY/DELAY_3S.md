...
| DSP負荷 | 5.50% |
| カテゴリ | ディレイ |
| 説明 | This long delay has a maximum length of 3000 mS.
...
| .const (定数) | 1354 bytes |
| エントリポイント | 0x00000BEC |
| ソースパス | `C:\Project\ZDL_Ver2.00\PROGRAM\Gen01\08.DLY\ZDL_DLY_Delay_ShortExRam\Debug` |
...
| 0x0024 | `Fx_DLY_Delay_tapmuteMute` | メインDSP |
| 0x0054 | `Fx_DLY_Delay_tapmuteOpen` | メインDSP |
| 0x0104 | `Fx_DLY_Delay_time_edit` | パラメータ変更 |
| 0x02B8 | `Fx_DLY_Delay_pp_edit` | パラメータ変更 |
| 0x02F0 | `Fx_DLY_Delay_ppTapOpen` | タップテンポ |
| 0x0314 | `Fx_DLY_Delay_outLv_edit` | パラメータ変更 |
| 0x0354 | `Fx_DLY_Delay_onf` | ON/OFF |
| 0x0470 | `Fx_DLY_Delay_mix_edit` | パラメータ変更 |
| 0x0508 | `Fx_DLY_Delay_hidamp_edit` | パラメータ変更 |
| 0x052C | `Fx_DLY_Delay_fb_edit` | パラメータ変更 |
| 0x0580 | `Fx_DLY_Delay_init` | 初期化 |
| 0x0620 | `Fx_DLY_Delay` | メインDSP |
| 0x0A60 | `GetString_Tail` | 文字列生成 |
| 0x0AB4 | `GetString_1_5000_Sync` | 文字列生成 |
| 0x0BEC | `Dll_Delay` | DLLエントリ |
